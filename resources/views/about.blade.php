                ...
                <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                    <div class="card bg-light">
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="lead"><b>Ahmad Fahrudin</b></h2>
                        ...
                        <div class="card-footer">
                            <div class="text-right">    
                                <a target="_blank" href="https://github.com/ahmadrockets" class="btn btn-sm btn-primary">
                ...
                <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                    <div class="card bg-light">
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="lead"><b>Mardiya Mardha</b></h2>
                                    <p class="text-muted text-sm"><b>About: </b> Web Designer / UX / Graphic Artist / Coffee Lover </p>
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Address: Demo Street 123, Demo City 04312, NJ</li>
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: + 800 - 12 12 23 52</li>
                        ...
                        <div class="card-footer">
                            <div class="text-right">    
                                <a target="_blank" href="https://github.com/mardhamardiya18" class="btn btn-sm btn-primary">
                                    <i class="fas fa-github"></i> View Github
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                    <div class="card bg-light">
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="lead"><b>Indra Rasyid</b></h2>
                                    <p class="text-muted text-sm"><b>About: </b> Web Designer / UX / Graphic Artist / Coffee Lover </p>
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Address: Demo Street 123, Demo City 04312, NJ</li>
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: + 800 - 12 12 23 52</li>
                        ...
                        <div class="card-footer">
                            <div class="text-right">    
                                <a target="_blank" href="https://github.com/indrarasyid07" class="btn btn-sm btn-primary">
                                    <i class="fas fa-github"></i> View Github
                                </a>
                            </div>
                        </div>
